...
export default function Carrer() {
	const data = [
		...
		},
		{
			...
			desc: "<a class='underline-hover' target='_blank' href='http://www.consultecdba.com/'>Consultec DBA</a> - Projetos de aplicações de gestão corporativa.",
		},
	];
	return (
		<Container className="responsive-container" id="carreira">
			<div className="responsive-content">
				...
				<main>
					{data.map((item) => (
						<HistoryPoint key={item.pos} pos={item.pos} item={item} length={data.length} />
					))}
				</main>
			</div>
		</Container>
